...
function create_post_type_gallery() {
    ...
    $args = array(
        'description'         => __( 'gallery content', '相簿' ),
            'labels'              => $labels,
...
function create_gallery_taxonomies() {
  ...
  $args = array(
    ...
    'query_var'         => true,
    'show_in_nav_menus' => true,
    'rewrite'           => array( 'slug' => 'gallery_taxonomy', 'with_front' => true ),
  );
  $postTypes = array('gallery');
  register_taxonomy( 'tax_gallery', $postTypes, $args );
}
